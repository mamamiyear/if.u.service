...
@authorized_router.post("/api/user/logout")
...
@authorized_router.delete("/api/user")
...
@authorized_router.post("/api/user/me/avatar")
...
@authorized_router.put("/api/user/phone")
...
@authorized_router.put("/api/user/email")
